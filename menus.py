...
class Menu:
    ...
    def create_keyboard_datos(self, user_id=-1, incluir_enrolled=False):
        with CovidDataBase() as base:
            ...
            for info in INFO_DATOS:
                if info[1] in user_data_suscription and incluir_enrolled:
    ...
    def notificaciones(self, user_id):
        info_menu = self.create_keyboard_datos(user_id, incluir_enrolled=True)
        return self.generate_menu(info_menu)
